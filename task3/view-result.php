<?php
    ...
    {
         $test=get_safe_value($con,$_POST['class']);
         
         $query="select * from examresults where examID='$test' ";
   ...
   function teacherDashboard()
{
 ...
 <div class=" profile-container">
    <p>Please select:</p>
    <form method="POST">
    <input type="radio" name="class" id="test1" value=1>
    <label for="test1">Cummilative Test Class-11</label>
    <br>
    <input type="radio" name="class" id="test2" value=2>
   
    <label for="test2">Cummilative Test Class-12 </label>
    <br>
    ...
    <input class="btn" type="button" value="Back" onclick="teacherDashboard()">
 </div>
